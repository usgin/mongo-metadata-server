...
function reduceMinimalist (data) {
  return data;
}
...
function reduceCinergi (data) {
  return data;
}

exports.mapMinimalist = mapMinimalist;
exports.reduceMinimalist = reduceMinimalist;
exports.mapCinergi = mapCinergi;
exports.reduceCinergi = reduceCinergi;